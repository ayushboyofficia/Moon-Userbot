...
@Client.on_message(filters.command("love") & (filters.me | filters.user(SUDO_USERS)))
async def love_command(client, message):
    ...
    await message.reply_photo(random.choice(love_images))

add_command_help(
    "Love",
    [
        ["love", "Send random love pictures"],
    ]
)
